...
const fr = {
    ...
    instructionsThirdPart:{
        ...
        freqMPL: "<b>En moyenne, une personne sur {frequency}</b> sera sélectionnée à la fin de l'expérience pour qu'<b>un de ses choix à la tâche de prise de décision (LMP) soit réellement payé</b>. Le bonus pour la tâche de span de mémoire est lui calculé <b>pour chaque personne</b>.",
    ...
    originalInstructionsDecisionTable:{
    ...
    instructionsDecisionTable:{
        ...
        description: `<ul>
        <li>Chaque lot contient 100 boîtes.</li>
        <li>Chaque boîte peut contenir de l'argent (positif ou négatif).</li>
        </ul>`,
        bonusRandomBox: 'Comment vous serez payé ? L\'ordinateur prend l\'argent <b>d\'une boîte tirée au hasard</b> dans le lot que vous avez choisi et l\'ajoute à votre <b>bonus</b>. C\'est la règle de paiement dite "une boîte au hasard".',
        bonusAverageBox: "Comment vous serez payé ? L'ordinateur prend <b>la moyenne</b> de l'argent dans les boîtes du lot que vous avez choisi et l'ajoute à votre <b>bonus</b>. C\'est la règle de paiement dite \"la boîte moyenne\".",
        breakDownWithExamples: "Expliquons avec deux exemples.",
        example1: "Exemple 1:",
        example1ExplanationLottery: `<ul>
        <li>Si vous choisissez le <span style='color:red'>lot A</span>, comme il y a 50 boîtes avec 16€ et 50 avec 0€, vous avez <b>50% de chance d'avoir <span style='color:green'>16€</span></b>, et 50% de chance d'avoir 0€.</li>
        <li>Si vous choisissez le <span style='color:blue'>lot B</span>, comme toutes les boîtes contiennent 4€, vous êtes <b>sûr·e d'avoir <span style='color:green'>4€</span></b> (100% de chance).</li>
        </ul>`,
        example1ExplanationMirror: `<ul>
        <li>Si vous choisissez le <span style='color:red'>lot A</span>, comme il y a 50 boîtes avec 16€ et 50 avec 0€, la moyenne est de (16€ x 50 + 0€ x 50) divisé par 100 = 8€. Vous êtes <b>sûr·e d'avoir <span style='color:green'>8€</span> (100% de chance)</b>.</li>
        <li>Si vous choisissez le <span style='color:blue'>lot B</span>, comme toutes les boîtes contiennent 4€, la moyenne est de 4€, vous êtes <b>sûr·e d'avoir <span style='color:green'>4€</span></b> (100% de chance).</li>
        </ul>`,
        example2: "Exemple 2:",
        example2ExplanationLottery: `<ul>
        <li>Si vous choisissez le <span style='color:red'>lot A</span>, comme il y a 25 boîtes avec -12€ et 75 avec 0€, vous avez <b>25% de chance d'avoir <span style='color:green'>-12€</span></b>, et 75% de chance d'avoir 0€.</li>
        <li>Si vous choisissez le <span style='color:blue'>lot B</span>, comme toutes les boîtes contiennent -3€, vous êtes <b>sûr·e d'avoir <span style='color:green'>-3€</span></b> (100% de chance).</li>
        </ul>`,
        example2ExplanationMirror: `<ul>
        <li>Si vous choisissez le <span style='color:red'>lot A</span>, comme il y a 25 boîtes avec -12€ et 75 avec 0€, la moyenne est de (-12 x 25 + 0 x 75) divisé par 100 = -3€. Vous êtes <b>sûr·e d'avoir <span style='color:green'>-3€</span></b> (100% de chance).</li>
        <li>Si vous choisissez le <span style='color:blue'>lot B</span>, comme toutes les boîtes contiennent -3€, la moyenne est de -3€, vous êtes <b>sûr·e d'avoir <span style='color:green'>-3€</span></b> (100% de chance).</li>
        </ul>`,
        clickNext: "Cliquez sur <strong>Suivant</strong> pour découvrir comment choisir un lot !",
        clickNextSecond: "Cliquez sur <strong>Suivant</strong> pour faire un entraînement aux questions de compréhension !"
    },
    instructionsClickToChoose:{
        ...
        clickNext: "Cliquez sur <strong>Suivant</strong> pour faire un entraînement aux questions de compréhension !"
    },
    ...
    instructionsChoosingASetOfBoxes: {
        ...
        description: `Dans la troisième partie, vous devez choisir entre différentes versions du <span style='color:red'>lot A</span> et du <span style='color:blue'>lot B</span>.`,
        example1: ` 
        Dans l'exemple ci-dessous, le lot A est le même pour toutes les versions du tableau. Cependant le lot B change, à chaque version l'argent dans chaque boîte augmente de 1€.`,
        ...
        severalTablesDescription: `Vous effectuerez cette tâche plusieurs fois pendant la troisième partie de l'expérience, avec différents tableaux.`,
        ...
        endowmentsMPL: `Pour chaque tableaux, si vous êtes sélectionné·e pour être payé·e un de vos choix, l'ordinateur rajoutera une somme initiale d'argent. Elle est indiquée en <span style='color:green'>vert</span> en haut de chaque tableau.`,
    ...
    comprehensionQMPLMirror: {
        q1: {
            ...
            La règle de paiement est "la moyenne des boîtes".
            <br><br>
            Quelle est la chance que vous gagniez exactement 10€ ?`,
        ...
        q2: {
            promptTraining: "Quelle est la chance que vous gagniez exactement 5€ ?",
            promptMain: "Quelle est la chance que vous gagniez exactement 1€ ?",
        ...
        q3: {
            promptTraining: "Quelle est la chance que vous gagniez exactement 0€ ?",
            promptMain: "Quelle est la chance que vous gagniez exactement 0€ ?",
        ...
        q4: {
            promptTraining: "Quelle est la chance que vous gagniez exactement 10€ ?",
            promptMain: "Quelle est la chance que vous gagniez exactement 5€ ?",
    ...
    loopAgainSpanMplTraining: {
        ...
        readInstructions: "Vous êtes invité·e à lire les consignes si vous avez un doute pour répondre aux questions.",
        clickNext: "Appuyez sur <strong>Suivant</strong> pour répondre de nouveau !",
    },
