...
const en = {
    ...
    overallTrainingFeedback: {
        ...
        explain1Back: "The last letter before the visual n-back was K, and the first letter after was C. Therefore you had to press the key 'F' when seeing the 'C' after the visual nback.",
        explain2Back: "The last two letters before the visual n-back were 'A' and 'P', and the first two letters after were 'P' and 'K'. Therefore you had to press the key 'F' when seeing the 'P' and 'K' after the visual nback ('P' different from 'A' and 'K' from 'P').",
        explain3Back: "The last three letters before the visual n-back were 'B', 'A', 'A', and the first three letters after were 'B', 'A', 'P'. Therefore you had to press the key 'J' when seeing 'B' and 'A' and 'F' when seeing 'P' after the visual nback ('P' different from 'A').",
...
const fr = {
    ...
    overallTrainingFeedback: {
        ...
        explain1Back: "La dernière lettre avant le n-back visuel était 'K', et la première après était 'C'. Vous deviez donc appuyer sur la touche 'F' lorsque vous voyiez le 'C' après le n-back visuel ('C' différent de 'K').",
        explain2Back: "Les deux dernières lettres avant le n-back visuel étaient 'A' et 'P', et les deux premières après étaient 'P' et 'K'. Vous deviez donc appuyer sur la touche 'F' lorsque vous voyiez le 'P' et le 'K' après le n-back visuel ('P' différent de 'A' et 'K' de 'P').",
        explain3Back: "Les trois dernières lettres avant le n-back visuel étaient 'B', 'A', 'A', et les trois premières après étaient 'B', 'A', 'P'. Vous deviez donc appuyer sur la touche 'J' lorsque vous voyiez 'B' et 'A' et sur la touche 'F' lorsque vous voyiez 'P' après le n-back visuel ('P' différent de 'A').",
